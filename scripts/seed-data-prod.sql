...
INSERT INTO Users (username, password, hint, createdAt, updatedAt) VALUES ('guest','guest','the password is guest',now(),now());
INSERT INTO Users (username, password, hint, createdAt, updatedAt) VALUES ('robin','robin1','try robin1',now(),now());
...
INSERT INTO Bays (baynumber, createdAt, updatedAt) VALUES (1,now(),now());
INSERT INTO Bays (baynumber, createdAt, updatedAt) VALUES (2,now(),now());
INSERT INTO Bays (baynumber, createdAt, updatedAt) VALUES (3,now(),now());
...
INSERT INTO Customers (firstname,lasttname,address,phonenumber,createdAt,updatedAt) 
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '8002347654');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '7575556598');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '5558675309');
...
--   now()         as createdAt,
--   now()         as updatedAt,
--   (select id from Customers where phonenumber = '804555398');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '4205559874');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '7575559512');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '8015556523');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '5558009823');
...
SELECT 
   ...
   now()         as createdAt,
   now()         as updatedAt,
   (select id from Customers where phonenumber = '5559871478');

-- '      INSERT INTO Vehicles \n(vehicle_vin, vehicle_color, vehicle_year, vehicle_make, vehicle_model, vehicle_engine, vehicle_transmission, createdAt,updatedAt, CustomerId)\nSELECT \n   \'3B7HF13YXWG209744\' as vehicle_vin,\n   \'RED\'       as vehicle_color,\n   \'1998\'        as vehicle_year,\n   \'Dodge\'        as vehicle_make,\n   \'Ram Pickup 1500\' as vehicle_model,\n   NULL          as vehicle_engine,\n   NULL          as vehicle_transmission,\n   now()         as createdAt,\n   now()         as updatedAt,\n   (select id from Customers where phonenumber = \'8005551911\');'
